...
if __name__ == "__main__":
    ...
    general_parser.add_argument("--timeout", type=int, metavar="timeout",
                                help="Maximum run time for commands (in seconds)", default=TIMEOUT)
    ...
    if mode == "align":
        ...
        sralign_parser.add_argument("--ref_gtf", metavar="ref_gtf",
                                  ...
                                  ( --known-splicesite-infile option for HISAT will be created based on this file)",
                                    default="")
        ...
        sralign_parser.add_argument("--large_genome", help="Size of genome is larger than 4Gb or NO.", default=False,
        ...
        reconstructor_parser.add_argument("--stringtie_opts", metavar="stringtie_opts",
                                  ...
                                  (should be put between \" \") \
                                  (For StringTie check https://ccb.jhu.edu/software/stringtie/index.shtml?t=manual).",
                                          default="")
        ...
        lralign_parser.add_argument("--starlong", help="Path to STARlong executable (version 2.5.0a or later)",
                                    default=STARLONG)
        ...
        long_reconstructor_parser.add_argument("--long_reconstructor", metavar="long_reconstructor",
                                               help="The long-read transcriptome reconstruction tool to use.",
                                               default="IDP")
        ...
        long_fusion_parser.add_argument("--star_dir", help="Path to the directory with STAR executable",
                                        default=STAR_DIR)
        long_fusion_parser.add_argument("--bowtie2_dir", help="Path to the directory with bowtie2 executable",
                                        default=BOWTIE2_DIR)
        ...
        long_fusion_parser.add_argument("--gmap_idx", metavar="align_idx",
                                        help="Path to the directory with GMAP index for the reference genome",
                                        required=True)
        long_fusion_parser.add_argument("--idpfusion", help="Path to runIDP.py script in IDP-fusion package",
                                        default=IDPFUSION)
        ...
        variant_parser.add_argument("--AddOrReplaceReadGroups_opts", metavar="AddOrReplaceReadGroups_opts",
                                  ...
                                  (should be put between \" \") \
                                   (For Picard check https://broadinstitute.github.io/picard/command-line-overview.html).",
                                    default="SO=coordinate RGLB=lib1 RGPL=illumina RGPU=unit1 RGSM=sample")
        ...
        variant_parser.add_argument("--SplitNCigarReads_opts", metavar="SplitNCigarReads_opts",
                                  ...
                                  (should be put between \" \") \
                                   ...
                                   https://software.broadinstitute.org/gatk/gatkdocs/org_broadinstitute_gatk_tools_walkers_rnaseq_SplitNCigarReads.php).",
                                    default=GATK_SN_OPT)
        ...
        variant_parser.add_argument("--BaseRecalibrator_opts", metavar="BaseRecalibrator_opts",
                                  ...
                                  (should be put between \" \") \
                                   ...
                                   https://software.broadinstitute.org/gatk/gatkdocs/org_broadinstitute_gatk_tools_walkers_bqsr_BaseRecalibrator.php).",
                                    default="")
        variant_parser.add_argument("--PrintReads_opts", metavar="PrintReads_opts",
                                  ...
                                  (should be put between \" \") \
                                   ...
                                   https://software.broadinstitute.org/gatk/gatkdocs/org_broadinstitute_gatk_tools_walkers_readutils_PrintReads.php).",
                                    default="")
        ...
        variant_parser.add_argument("--VariantFiltration_opts", metavar="VariantFiltration_opts",
                                  ...
                                  (should be put between \" \") \
                                   ...
                                   https://software.broadinstitute.org/gatk/guide/tooldocs/org_broadinstitute_gatk_tools_walkers_filters_VariantFiltration.php).",
                                    default=GATK_VF_OPT)
    elif mode == "editing":
        ...
        all_parser.add_argument("--lordec_opts", metavar="lordec_opts",
                                help="Other options used for LoRDEC. \
                                  (should be put between \" \") \
                                   (For LoRDEC check http://www.atgc-montpellier.fr/lordec/README.html).", default="")
        all_parser.add_argument("--starlong", help="Path to STARlong executable (version 2.5.0a or later)",
                                default=STARLONG)
        ...
        all_parser.add_argument("--bowtie2_dir", help="Path to the directory with bowtie2 executable",
                                default=BOWTIE2_DIR)
